...
import { Vibration } from 'react-native';
 ...
 class Removepage1 extends React.Component {
   constructor(props) {
     super(props);
     console.log('showbeforeremove;constructor;props=', this.props);
   ...
   static contextTypes = {
    ...
    handleremove = async (e) => {
      console.log('showbeforeremove;handleremove')
      e.preventDefault();
      console.log('showbeforeremove;handleremove', this.props.noteloc)
    ...
    render() {
        ...
        if (!note) { 
          console.log('showbeforeremove;render;!note=return null')
          return null; 
        }
        return (
